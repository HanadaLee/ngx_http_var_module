...
ngx_http_var_create_variable(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    ngx_conf_log_error(NGX_LOG_EMERG, cf, 0, "http_var: inserting variable \"%V\" into configuration", &var_name);
    ...
    ngx_conf_log_error(NGX_LOG_EMERG, cf, 0, "http_var: successfully pushed variable \"%V\" into vars array", &var_name);
